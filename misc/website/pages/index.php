  ...
  <body>
    ...
    <div id="wrapper" ng-controller='IndexController'>
        ...
        <div class="navbar-default sidebar" role="navigation">
          <div class="sidebar-nav navbar-collapse">
            <ul class="nav" id="side-menu">
              <li>
                <a href="index.php"><i class="fa fa-dashboard fa-fw"></i> Temperaure Sensor</a>
              </li>
            </ul>
          </div>
          <!-- /.sidebar-collapse -->
      ...
      <div id="page-wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h1 class="page-header">Temperature Sensor</h1>
          </div>
          <div class="col-lg-3 col-md-6">
            <div class="panel panel-primary">
              ...
              <div class="panel-footer">
                <span class="pull-left">Last Measure</span>
          ...
          <div class="col-lg-3 col-md-6">
            <div class="panel panel-green">
              ...
              <a href="#">
              <div class="panel-footer">
                <span class="pull-left">Day Average</span>
          ...
          <div class="col-lg-3 col-md-6">
            <div class="panel panel-yellow">
              ...
              <a href="#">
              <div class="panel-footer">
                <span class="pull-left">Day Min</span>
                <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                <div class="clearfix"></div>
              </div> </a>
            </div>
          ...
          <div class="col-lg-3 col-md-6">
            <div class="panel panel-red">
              ...
              <a href="#">
              <div class="panel-footer">
                <span class="pull-left">Day Max</span>
                <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                <div class="clearfix"></div>
              </div> </a>
            </div>
